"""Instahyre job fetcher for India PM opportunities."""
...
class InstahyreFetcher(BaseIndiaFetcher):
    """Instahyre job fetcher with async HTTP and BeautifulSoup."""
    ...
    def _parse_job_element(self, element) -> Dict[str, Any]:
        ...
        try:
            # Extract title
            title_elem = element.find(['h2', 'h3', 'h4'], class_=lambda x: x and 'title' in x.get('class', '').lower())
